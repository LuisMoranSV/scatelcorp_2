                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="proyect_name" id="proyect_name" placeholder="Nombre del proyecto" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <datalist id="proyect_clientlist">
                                                           <?php
                                                            ...
                                                            $sqlcg = "SELECT client_id, client_first_name, client_first_lastname FROM client_table WHERE client_active = 1";
