...
<head>
    ...
    <title>Nuevo Proyecto | SCATEL CORP</title>
...
?>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-auto">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Ingrese los datos del proyecto</h4>
                                </div>
                                <div class="content">
                                   <?php
                                    $proyect_id = $_POST['edit'];
                                    $cnn = mysqli_connect("50.62.177.60","asi1","proyecto","scatel")
    or die('cant conect');

    $sqlcg = "SELECT proyect_name, client_id FROM proyect_table WHERE proyect_id = '". $proyect_id ."';";
    ...
    else
    {
        ...
        echo("
        <form action='modifyproyect.php' method='post'>
                                        <div class='row'>
                                            <div class='col-md-6'>
                                                <div class='form-group'>
                                                    <label>Nombre del Proyecto</label>
                                                    <input type='text' class='form-control' name='proyect_name' id='proyect_name' placeholder='Nombre del proyecto' value='". $row[0] ."' required>
                                                    <input type='hidden' id='proyect_id' name='proyect_id' value='". $proyect_id ."'>
                                                </div>
                                            </div>
        ");
    }
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input  autoComplete='on' list='proyect_clientlist' id='proyect_client' name='proyect_client' class='col-sm-6 custom-select custom-select-sm' value='". $row[1] ."'/>");
                                                            ?>
                                                    </div>
