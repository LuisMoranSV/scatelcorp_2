                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-auto">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Ingrese los datos de la cotizacion.</h4>
                                </div>
                                <div class="content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="quotation_name" placeholder="Nombre de la cotización" required>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <datalist id="proyect_quotationlist">
                                                           <?php
                                                            ...
                                                            or die('cant conect');
                                                            $sqlcg = "SELECT proyect_id, proyect_name FROM proyect_table WHERE proyect_active = 1";
                                                        ...
                                                        <input  autoComplete="on" list="proyect_quotationlist" id="quotation_proyect" name="quotation_proyect" class="col-sm-6 custom-select custom-select-sm"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="quotation_payment" id="quotation_payment" class="form-control" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" class="form-control" id="quotation_conditions" name="quotation_conditions" placeholder="Aqui escriba las condiciones" value="" required> </textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div clas="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" class="form-control" id="quotation_warranty" name="quotation_warranty" placeholder="Aqui escriba la garantia" value="" required> </textarea>
                                                </div>
                                            </div>
                                        </div>
...
<?php
    ...
    $(document).ready(function() {
        ...
        $.notify({
            ...
            message: 'El proyecto no pudo ser agregado'
