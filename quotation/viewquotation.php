                                    ...
                                    <div class="content">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div class="">
                                                    <label>Nombre cotizacion</label>
                                                    <label for=""><u></u></label>
                                                </div>
                                                <div class="">
                                                    <label>Version de cotizacion</label>
                                                    <label for=""><u></u></label>
                                                </div>
                                                <div class="">
                                                    <label>fecha de cot.</label>
                                                    <label for=""><u></u></label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="">
                                                    <label>Validacion de cot.</label>
                                                    <label for=""><u></u></label>
                                                </div>
                                                <div class="">
                                                    <label>Condicion de val.</label>
                                                    <label for=""><u></u></label>
                                                </div>
                                            </div>
