...
<head>
    ...
    <title>Eliminar Cotización | SCATEL CORP</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Eliminacion de la cotización.</h4>
                                </div>
                                <div class="content">
                                    <form>
                                        <div class="row">
                                            <div class="col-md-auto">
                                                <div class="form-group">
                                                    <label>Ingrese el ID de la cotización</label>
                                                    <input type="text" name="id_quotation" id="id_quotation" class="form-control" placeholder="ID cotización" value="" required>
                                                </div>
                                            </div>
                                        </div>
