...
<head>
    ...
    <title>Ver Proveedor | SCATEL CORP</title>
...
?>
        ...
        <div class="main-panel">
            ...
            <div class="content">
                ...
                <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tabla de proveedores</h4>
                                <p class="category">Cada fila es un proveedor</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped" id="table_provider">
                                    <thead>
                                       <tr>
                                        <th>ID</th>
                                        <th>Primer nombre</th>
                                    ...
                                    <tbody id="edit_table_provider">
                                        <tr data-row-id="">
                                            <?php
    $cnn = mysqli_connect("50.62.177.60","asi1","proyecto","scatel")
    or die('cant conect');

    $sqlcg = "SELECT provider_id, provider_first_name, provider_first_lastname, provider_NIT,  provider_NCR, provider_PhoneNumber FROM provider_table WHERE provider_active = 1";
    ...
    else
    {
        while ($row = mysqli_fetch_array($result))
        {
            ...
            if($row[7] == 0){
                echo("
                <form action='deactivateprovider.php' method='post'>
    ...
    ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
             <form action='selectproviderdeact.php' method='post'>
             <button type='submit' class='btn btn-danger'>Proveedores deshabilitados</button>
              </form>
              </div>
              </div>
              </div>
...
<?php
    ...
    $(document).ready(function() {
        ...
        $.notify({
            ...
            message: 'El proveedor no pudo ser modificado'
    ...
    $(document).ready(function() {
        ...
        $.notify({
            icon: 'pe-7s-close-circle',
            message: 'El proveedor no pudo ser deshabilitado'
    ...
    $_SESSION['notification'] = null;
        break;
    case "provider_cant_deactivaded":
        echo("
    <script type='text/javascript'>
    $(document).ready(function() {
