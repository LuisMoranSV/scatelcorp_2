...
<head>
    ...
    <title>Nuevo proveedor | SCATEL CORP</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-auto">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Ingrese los datos del proveedor.</h4>
                                </div>
                                <div class="content">
                                           ...
                                           <div class="form-group">
                                                        <label style="margin-left: 20px;">Tipo de persona</label>
                                                         <div class="input-group mb-3">
                                                          <input type="radio" id="nature_provider" name="nature_provider" value="0" checked onclick="natural()">Natural
                                                          <input type="radio" id="nature_provider" name="nature_provider" value="1" onclick="ejecutiva()">Ejecutiva<br>
                                                          <script>
                                                            function natural() {
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="first_name_provider" id="first_name_provider" placeholder="Primer nombre" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Segundo nombre</label>
                                                    <input type="text" name="second_name_provider" id="second_name_provider" class="form-control alpha-only" placeholder="Segundo nombre">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control alpha-only" name="first_lastname_provider" id="first_lastname_provider" placeholder="Primer apellido">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Segundo apellido</label>
                                                    <input type="text" name="second_lastname_provider" id="second_lastname_provider" class="form-control alpha-only" placeholder="Segundo apellido">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>NIT</label>
                                                    <input type="text" class="form-control allownumericwithoutdecimal nit" id="nit_provider" name="nit_provider" placeholder="NIT" value="" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>NCR</label>
                                                    <input type="text" class="form-control allownumericwithoutdecimal ncr" id="ncr_provider" name="ncr_provider" placeholder="NCR" value="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control allownumericwithoutdecimal" placeholder="Numero de telefono" name="phone_number_provider" id="phone_number_provider" value="" required>
                                                </div>
                                            </div>
                                        </div>
