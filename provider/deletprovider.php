...
<head>
    ...
    <title>Eliminar proveedor | SCATEL CORP</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Eliminacion del proveedor</h4>
                                </div>
                                <div class="content">
                                    <form>
                                        <div class="row">
                                            <div class="col-md-auto">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="id_proveedor" id="id_proveedor" class="form-control" placeholder="ID del proveedor" value="" required>
                                                </div>
                                            </div>
                                        </div>
