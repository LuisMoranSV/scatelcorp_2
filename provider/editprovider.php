...
<head>
    ...
    <title>Modificar proveedor | SCATEL CORP</title>
...
?>
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                       ...
                       <ul class="dropdown-menu col"role="menu">
                            <li><a href="createprovider.php">Nuevo</a></li>
                            <li><a href="selectprovider.php">Gestionar</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" style="background-color:#b9b331; margin-left: 40px;" role="menu">
                            <li><a href="../proyects/createproyect.php">Nueva</a></li>
                            <li><a href="../proyects/selectproyect.php">Editar</a></li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-auto">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Modifique los datos del proveedor</h4>
                                </div>
                                <div class="content">
                                   <?php
                                    $provider_id = $_POST['edit'];
                                    $cnn = mysqli_connect("50.62.177.60","asi1","proyecto","scatel")
    or die('cant conect');

    $sqlcg = "SELECT provider_first_name, provider_second_name, provider_first_lastname, provider_second_lastname, provider_NIT,  provider_NCR, provider_PhoneNumber, provider_nature FROM provider_table WHERE provider_id = '". $provider_id ."';";
    ...
    else
    {
        ...
        echo("
                                    <form action='modifyprovider.php' method='post'>
                                    <div class='row'>
                                ...
                                if($row[7]==0){
                                                         echo(" <input type='radio' id='nature_provider' name='nature_provider' value='0' onclick='natural()' checked>Natural
                                                         <input type='radio' id='nature_provider' name='nature_provider' value='1' onclick='ejecutiva()'>Ejecutiva
                                                         ");
                                }
                                if($row[7]==1){
                                                          echo(" <input type='radio' id='nature_provider' name='nature_provider' value='0' onclick='natural()' >Natural
                                                         <input type='radio' id='nature_provider' name='nature_provider' value='1' onclick='ejecutiva()' checked>Ejecutiva
                                                         <script>
                                                             window.onload = function ejecutiva() {
                                                                document.getElementById('second_name_provider').disabled = true;
                                                                document.getElementById('first_lastname_provider').disabled = true;
                                                                document.getElementById('second_lastname_provider').disabled = true;
                                                            }
                                                            </script>
                                                         ");
                                }
        echo("
                                                          ...
                                                          <script>
                                                            function natural() {
                                                                document.getElementById('second_name_provider').disabled = false;
                                                                document.getElementById('first_lastname_provider').disabled = false;
                                                                document.getElementById('second_lastname_provider').disabled = false;
                                                            }
                                                              function ejecutiva() {
                                                                document.getElementById('second_name_provider').disabled = true;
                                                                document.getElementById('first_lastname_provider').disabled = true;
                                                                document.getElementById('second_lastname_provider').disabled = true;
                                                                document.getElementById('second_name_provider').value = '';
                                                                document.getElementById('first_lastname_provider').value = '';
                                                                document.getElementById('second_lastname_provider').value = '';
                                                            }
                                                            </script>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-6'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text' class='form-control' name='first_name_provider' id='first_name_provider' placeholder='Primer nombre' value='". $row[0] ."' required>
                                                </div>
                                            </div>
                                            <div class='col-md-6'>
                                                <div class='form-group'>
                                                    <label>Segundo nombre</label>
                                                    <input type='text' name='second_name_provider' id='second_name_provider' class='form-control alpha-only' placeholder='Segundo nombre' value='". $row[1] ."' >
                                                </div>
                                            </div>
                                        </div>
                                        <div class='row'>
                                            <div class='col-md-6'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text' class='form-control alpha-only' name='first_lastname_provider' id='first_lastname_provider' placeholder='Primer apellido' value='". $row[2] ."' >
                                                </div>
                                            </div>
                                            <div class='col-md-6'>
                                                <div class='form-group'>
                                                    <label>Segundo apellido</label>
                                                    <input type='text' name='second_lastname_provider' id='second_lastname_provider' class='form-control alpha-only' placeholder='Segundo apellido' value='". $row[3] ."' >
                                                </div>
                                            </div>
                                        </div>
                                        <div class='row'>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-5'>
                                                <div class='form-group'>
                                                    ...
                                                    <input type='text' class='form-control allownumericwithoutdecimal' placeholder='Numero de telefono' name='phone_number_provider' id='phone_number_provider'  value='". $row[6] ."'  required>
