...
?>
    ...
    $sqlcg = "SELECT provider_id, provider_first_name, provider_first_lastname, provider_NIT,  provider_NCR, provider_PhoneNumber FROM provider_table WHERE provider_active = 0";
