...
<head>
    ...
    <title>Ver cliente | SCATEL CORP</title>
...
?>
    ...
    $sqlcg = "SELECT client_id, client_first_name, client_first_lastname, client_NIT,  client_NCR, client_PhoneNumber FROM client_table WHERE client_active = 1";
    ...
    ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
             <form action='selectclientdeact.php' method='post'>
             <button type='submit' class='btn btn-danger'>Clientes deshabilitados</button>
              </form>
              </div>
              </div>
              </div>
...
<?php
    ...
    $(document).ready(function() {
        ...
        $.notify({
            icon: 'pe-7s-close-circle',
            message: 'El cliente no pudo ser habilitado'
