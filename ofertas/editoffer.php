                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-auto">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Busqueda de oferta a modificar</h4>
                                </div>
                                <div class="content">
                                    <form>
                                        <div class="row">
                                            <div class="col-md-auto">
                                                <div class="form-group">
                                                    <label>Ingrese el ID de la oferta</label>
                                                    <input type="text" name="id_quotation" id="id_quotation" class="form-control" placeholder="ID del cotización" value="" required>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-auto">
                            <div class="card">
                                <div class="header">
                                    <h4 class="title">Modificacion de los datos de la oferta</h4>
                                </div>
                                <div class="content">
                                    <form>
